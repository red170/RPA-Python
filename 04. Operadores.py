...
# --- PERTENENCIA (Si el primer elemento/variable esta contenido o no dentro del segundo elemento/variable)  -------------------------------------------------------------------------------------------------------
...
# --- IDENTIDAD (Si el primer elemento/variable es igual o no al segundo elemento/variable) -------------------------------------------------------------------------------------------------------
